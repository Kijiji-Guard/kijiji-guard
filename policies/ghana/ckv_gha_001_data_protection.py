...
class GhanaEncryptionAtRestCheck(BaseResourceCheck):
    def __init__(self):
        # Ghana Data Protection Act 2012, Section 22: Security of personal data.
        # Requires appropriate technical measures including encryption for stored data.
        name = "Mandate AES256 or KMS for all storage resources (Ghana DPA 2012, Section 22)"
        id = "CKV_GHA_001"
...
check = GhanaEncryptionAtRestCheck()
