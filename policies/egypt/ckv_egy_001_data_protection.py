...
class EgyptEncryptionAtRestCheck(BaseResourceCheck):
    def __init__(self):
        # Egypt Personal Data Protection Law (PDPL) No.151 of 2020,
        # Article 19: Security measures for personal data processing.
        # Requires appropriate technical and organisational measures including encryption.
        name = "Mandate AES256 or KMS for all storage resources (Egypt PDPL 2020, Article 19)"
        id = "CKV_EGY_001"
...
check = EgyptEncryptionAtRestCheck()
