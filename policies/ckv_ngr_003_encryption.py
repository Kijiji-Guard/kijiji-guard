...
class EncryptionAtRestCheck(BaseResourceCheck):
    def __init__(self):
        # NDPA Section 34: Duty of Care and Security.
        # Mandate high-grade encryption for all storage.
        name = "Mandate AES256 or KMS for all storage resources (NDPA Section 34)"
        id = "CKV_NGR_003"
