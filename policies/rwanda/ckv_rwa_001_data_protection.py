...
class RwandaEncryptionAtRestCheck(BaseResourceCheck):
    def __init__(self):
        # Rwanda Law No.058/2021 of 13/10/2021 on the Protection of Personal Data,
        # Article 22: Security of personal data processing.
        # Requires implementation of appropriate technical measures including encryption.
        name = "Mandate AES256 or KMS for all storage resources (Rwanda Law No.058/2021, Article 22)"
        id = "CKV_RWA_001"
...
check = RwandaEncryptionAtRestCheck()
