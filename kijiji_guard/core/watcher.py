...
from kijiji_guard.adapters.watch.nigeria      import NigeriaWatcher
from kijiji_guard.adapters.watch.ghana        import GhanaWatcher
from kijiji_guard.adapters.watch.kenya        import KenyaWatcher
from kijiji_guard.adapters.watch.rwanda       import RwandaWatcher
from kijiji_guard.adapters.watch.egypt        import EgyptWatcher
from kijiji_guard.adapters.watch.benin        import BeninWatcher
from kijiji_guard.adapters.watch.cote_divoire import CoteDivoireWatcher

def _get_data_dir() -> Path:
    """Get user data directory for Kijiji-Guard."""
    data_dir = Path.home() / ".kijiji-guard"
    data_dir.mkdir(exist_ok=True)
    return data_dir

DB_PATH = _get_data_dir() / ".watch_cache.db"
