...
Run with:
  py -m uvicorn kijiji_guard.api_server:app --reload --port 8000
"""
import json
import os
import sys
...
from kijiji_guard.core.orchestrator import KijijiOrchestrator
from kijiji_guard.core.report import KijijiReport
...
def _get_data_dir() -> _Path:
    ...
    data_dir = _Path.home() / ".kijiji-guard"
    data_dir.mkdir(exist_ok=True)
    return data_dir

HISTORY_FILE = str(_get_data_dir() / ".scan_history.json")
...
def watch_country(country: str) -> dict[str, Any]:
    ...
    from kijiji_guard.core.watcher import KijijiWatcher, WATCHERS
